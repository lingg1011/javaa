...
public class PanelDeal extends javax.swing.JPanel implements InChangePanelDeal{

    public PanelDeal() {
        initComponents();
        jPanel5.setLayout(new BorderLayout());
        jPanel5.add(new PanelLoanSlip(this));
        jPanel5.validate();
        jPanel5.repaint();
    }
    ...
    private void initComponents() {
        ...
        jPanel1.add(jPanel3);
        jPanel3.setBounds(10, 10, 253, 46);
        ...
        jLabel3.setText("Danh Sách Chi Tiết Phiếu Mượn");
        ...
        jPanel1.add(jPanel4);
        jPanel4.setBounds(270, 10, 253, 39);

        jPanel5.setBackground(new java.awt.Color(255, 255, 255));
        jPanel5.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Danh sách", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(255, 0, 0))); // NOI18N
        ...
        jPanel1.add(jPanel5);
        jPanel5.setBounds(10, 67, 1010, 600);

        jButton1.setText("Xuất File PDF");
        jPanel1.add(jButton1);
        jButton1.setBounds(0, 670, 155, 86);
        ...
        jButton2.setBounds(170, 670, 176, 86);
    ...
    private void jPanel4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel4MouseClicked
        ...
        jPanel5.setLayout(new BorderLayout());
        jPanel5.add(new PanelLoanSlipDetails(null,0));
        jPanel5.validate();
        jPanel5.repaint();
    ...
    public void onChange(String mamuontra) {
        ...
        jPanel3.setBackground(new Color(153, 153, 153));
        jPanel5.setLayout(new BorderLayout());
        jPanel5.add(new PanelLoanSlipDetails(mamuontra,0));
        jPanel5.validate();
        jPanel5.repaint();
    }
}
