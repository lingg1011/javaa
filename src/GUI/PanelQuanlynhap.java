...
public class PanelQuanlynhap extends javax.swing.JPanel implements InChangePanelDeal{

    public PanelQuanlynhap() {
        initComponents();
        jPanel5.setLayout(new BorderLayout());
        jPanel5.add(new PanelPhieuNhap(this));
        jPanel5.validate();
        jPanel5.repaint();
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Danh Sách Chi Tiết Phiếu Nhập");
    ...
    private void jPanel4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel4MouseClicked
        ...
        jPanel5.setLayout(new BorderLayout());
        jPanel5.add(new PanelChiTietPhieuNhap(null,0));
        jPanel5.validate();
        jPanel5.repaint();
    ...
    public void onChange(String mamuontra) {
        ...
        jPanel3.setBackground(new Color(153, 153, 153));
        jPanel5.setLayout(new BorderLayout());
        jPanel5.add(new PanelChiTietPhieuNhap(mamuontra,0));
        jPanel5.validate();
        jPanel5.repaint();
    }
}
